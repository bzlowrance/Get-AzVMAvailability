function Get-SkuRetirementInfo {
    ...
    $retirementLookup = @(
        ...
        @{ Pattern = '^Standard_M192i[a-z]*_v2$';      Series = 'M192iv2'; RetireDate = '2027-03-31'; Status = 'Retiring' }
        @{ Pattern = '^Standard_NV\d+s_v3$';           Series = 'NVv3';    RetireDate = '2026-09-30'; Status = 'Retiring' }
        @{ Pattern = '^Standard_NV\d+[a-z]*_v4$';      Series = 'NVv4';    RetireDate = '2026-09-30'; Status = 'Retiring' }
